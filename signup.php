...
<form action="" method="POST">
    ...
    <div class="card-body bg-light pt-5 px-4">
      <i class="fas fa-user-plus fa-6x mx-auto my-2 text-primary"></i>
      ...
      <input type="submit" class="form-control btn btn-primary" value="Sign Up" name="submit">
    </div>
  </div>
</form>
<style>
