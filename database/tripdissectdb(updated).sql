...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2023 at 05:01 AM
...
CREATE TABLE `pre_data` (
  `PRE_DATA_ID` int(11) NOT NULL,
  `mode_Of_Transportation` varchar(50) NOT NULL,
  `transport_Frequency` int(11) NOT NULL,
  `meat_Choice` varchar(50) NOT NULL,
  `flight_Frequency` int(11) NOT NULL,
  `flight_Options` varchar(50) NOT NULL,
  `user_name` varchar(50) NOT NULL,
  `flag` varchar(50) DEFAULT 'N'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `users` (`id`, `user_name`, `full_name`, `phone`, `email`, `address`, `pass`, `energyProvider`, `apartmentArea`, `people`, `rooms`, `meterID`) VALUES
(3, 'test', '', 0, '', '', '9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08', '', 0, 0, 0, 0),
(4, 'Ali', '', 0, '', '', '94419b99b12c11133a4dfeccc3e17885974beb48f7827c48239aabfbcad238d8', '', 0, 0, 0, 0);
...
--
ALTER TABLE `pre_data`
  MODIFY `PRE_DATA_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
